          ...
          {!submitted ? (
            <div>
              <div className="mb-6">
                ...
                <p className="text-neutral-500 text-xs sm:text-sm font-medium mt-1">
                  Are you an Influencer, Executive, Specialist, Creator, Model, or Editor? Join DigitalX’s creative network.
                </p>
              </div>
            ...
            <div className="py-8 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-neutral-600 text-sm font-medium max-w-md mx-auto mb-6">
                Thank you for applying to join the DigitalX Creative Collaborator Network. Our agency team will review your profile and get in touch soon.
              </p>
              <button
                type="button"
                onClick={handleClose}
