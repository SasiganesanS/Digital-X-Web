...
export default function CollaboratorProfilePage() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = collaborator ? `${collaborator.name} | Praskla Digital X` : "Praskla Digital X";
  }, [collaborator, slug]);
  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#050609]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 pb-24 sm:pb-32 lg:pb-40 box-border">
        ...
        {/* Profile Hero Card — Sleek & Compact Box Layout */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="w-full min-w-0 rounded-2xl bg-white border border-neutral-200/90 p-5 sm:p-7 lg:p-8 shadow-[0_12px_40px_rgba(0,0,0,0.1)] mb-10 sm:mb-12 text-[#111111] overflow-hidden box-border"
        >
