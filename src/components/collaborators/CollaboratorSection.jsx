          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <p className="text-neutral-600 text-sm sm:text-base lg:text-lg font-medium leading-relaxed mb-7 max-w-2xl">
                From content creators and models to editors and specialist freelancers, DigitalX works with a curated network of creative professionals to bring ambitious brand projects to life.
              </p>
            ...
            {/* Right Preview Grid Area (5 Cols) — Avatar Previews */}
            <div className="lg:col-span-5 w-full">
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-4">
                {COLLABORATORS_DATA.map((c, i) => (
                  <motion.div
                    key={c.slug}
                  ...
                  >
                    <Link
                      ...
                      className="group flex flex-col items-center sm:items-start p-4 rounded-2xl bg-white border border-neutral-200/90 shadow-sm hover:border-[#E31D2E]/30 hover:shadow-md transition-all duration-300 cursor-pointer"
                    >
                      <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-2xl overflow-hidden mb-3 border border-neutral-200 shadow-xs flex-shrink-0">
                        <img
                          src={c.image}
                          alt={c.name}
