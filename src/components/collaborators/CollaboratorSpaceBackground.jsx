...
export default function CollaboratorSpaceBackground() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none bg-[#050609]">
      ...
      >
        {/* ── URANUS VIEW 1: Main Cyan Ice Giant (Hero Top-Right Outer Edge) ── */}
        <motion.div
        ...
        {/* ── URANUS VIEW 2: Mid-Page Orbital Perspective (Mid Page Outer-Left Edge) ── */}
        <motion.div
        ...
        {/* ── URANUS VIEW 3: Lower Horizon View (Lower Right Outer Edge) ── */}
        <motion.div
