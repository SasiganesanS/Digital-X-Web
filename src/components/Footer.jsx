          ...
          >
            ...
            >
              <Link to="/" className="flex items-center gap-[18px] group w-fit">
                <div
                  className="w-[52px] h-[52px] rounded-[14px] bg-[#FFFFFF] p-[8px] flex items-center justify-center border border-black/[0.06] shadow-[0_10px_30px_rgba(0,0,0,0.18)] shrink-0 transition-all duration-300 group-hover:scale-[1.06] group-hover:-translate-y-1 group-hover:shadow-[0_12px_25px_rgba(227,29,46,0.25)]"
                >
                  <img
                    src={Logo}
