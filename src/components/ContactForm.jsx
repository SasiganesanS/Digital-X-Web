      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="w-[94%] sm:w-full max-w-[540px] bg-white rounded-2xl sm:rounded-[28px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.22)] border border-[#111111] relative flex flex-col my-auto max-h-[90dvh] overflow-y-auto custom-scrollbar text-gray-900 font-sans p-4 sm:p-7 pb-8 sm:pb-10 z-10"
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div>
                  ...
                  <div
                    ...
                    className={`relative flex items-center w-full h-11 bg-white hover:bg-gray-50/80 focus-within:bg-white border rounded-xl transition-all duration-200 ${
                      errors.phone
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        className="w-4.5 h-auto rounded-xs object-cover shadow-2xs"
                      />
                    ...
                    <input
                      ...
                      className="w-full h-full px-3 bg-transparent text-sm text-[#111111] placeholder:text-gray-400 font-medium outline-none rounded-r-xl"
                    />
