...
export default function PlatformPlanModal({
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div className="bg-[#ECECEC] text-[#111111] font-sans w-full max-w-[1000px] min-h-[620px] max-h-[680px] rounded-[30px] border border-black/10 shadow-[0_25px_60px_rgba(0,0,0,0.35)] overflow-hidden flex flex-col relative select-none">
