...
export default function BlogSpaceBackground() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none bg-[#050609]">
      ...
      >
        {/* ── PLUTO VIEW 1: Main Icy Planet (Hero Top-Right Outer Edge) ── */}
        <motion.div
        ...
        {/* ── PLUTO VIEW 2: Mid-Page Orbital Perspective (Mid Page Outer-Left Edge) ── */}
        <motion.div
        ...
        {/* ── PLUTO VIEW 3: Lower Horizon View (Lower Right Outer Edge) ── */}
        <motion.div
