  ...
  return createPortal(
    (
      ...
      >
        <div 
          ref={modalRef}
          className="w-full bg-white rounded-xl shadow-2xl transform transition-all flex flex-col"
          style={{
            position: 'fixed',
            top: '50%',
            left: '50%',
        ...
        <button
          ...
          className="absolute top-4 right-4 bg-white text-gray-600 hover:text-gray-800 p-0 rounded-full shadow-md transition-colors z-20 border border-gray-200 w-10 h-10 flex items-center justify-center"
        ...
        {/* Header */}
  <div className="border-b border-gray-200 p-6 pr-14 flex-shrink-0">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-[#371445]">
                Apply for {job.title}
              </h2>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  maxLength={18}
                  className={`w-full px-4 py-2 border rounded-lg text-[#371445]
                            focus:ring-2 focus:ring-[#371445] focus:border-[#371445]
            ...
            <div>
              ...
              <div className="relative flex">
                ...
                >
                  <button
                    type="button"
                    className="flex items-center px-3 py-2 border border-r-0 border-gray-300 rounded-l-lg bg-gray-50 hover:bg-gray-100 focus:outline-none"
                  ...
                  {showCountryList && (
                    <div className="absolute z-10 mt-1 w-56 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                ...
                <input
                  ...
                  required
                  maxLength={10}
                  className={`w-full px-4 py-2 border rounded-r-lg text-[#371445]
                            focus:ring-2 focus:ring-[#371445] focus:border-[#371445]
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">{formData.coverLetter.length}/500 characters</p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-center w-full">
                <label className={`w-full flex flex-col items-center px-4 py-6 bg-white
                                border-2 border-dashed rounded-lg cursor-pointer
                                ${errors.resume ? 'border-red-500' : 'border-gray-300 hover:border-[#371445]'}`}>
        ...
        <div className="border-t border-gray-200 p-4 sm:p-6 flex-shrink-0">
          <div className="flex justify-between sm:justify-end items-center space-x-3 sm:space-x-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 sm:flex-none px-4 sm:px-6 py-2 border border-gray-300 rounded-lg text-gray-700
                        hover:bg-gray-50 transition-colors duration-300 font-medium text-sm sm:text-base"
        ...
        {submitSuccess && (
          <div className="absolute inset-0 flex items-center justify-center bg-white/90 rounded-xl">
            <div className="text-center p-6 bg-white rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-bold text-[#371445] mb-2">Application Submitted Successfully!</h3>
