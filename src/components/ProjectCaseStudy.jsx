...
const ProjectCaseStudy = () => {
  ...
  return (
    <div style={{ background: "#080808" }}>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 lg:px-16 pb-20 pt-40">
          ...
          >
            ...
            {/* Eyebrow badge */}
            <div className="relative inline-flex items-center gap-3 mb-8 px-6 py-3 rounded-full border border-neutral-700 bg-white/5 shadow-sm">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#FF2B2B] opacity-75" />
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#FF2B2B]" />
              </span>
            ...
            <p className="text-white/60 text-lg md:text-xl mb-8 max-w-2xl">{project.description}</p>
            ...
            <div className="flex flex-wrap gap-4 mb-10 items-center">
              <motion.span
                ...
                className="px-6 py-2.5 rounded-xl text-sm font-black tracking-wide border border-neutral-700 bg-white/5 text-white shadow-sm"
              >
                {project.tags}
              </motion.span>
              <motion.span 
                ...
                className="px-6 py-2.5 rounded-xl text-sm font-bold flex items-center gap-3 border border-neutral-700 bg-white/5 text-white/90 shadow-sm"
              >
            ...
            <div className="flex flex-wrap gap-3">
              {project.services.map((svc, i) => (
                <motion.span
                  ...
                  className="text-[11px] font-black uppercase tracking-wider px-5 py-2.5 rounded-lg border border-neutral-800 bg-white/5 text-white/80"
                >
                  {svc}
                </motion.span>
              ))}
          ...
          >
            <div className="w-6 h-10 border border-white/15 rounded-full flex items-start justify-center p-1.5">
              <motion.div
                className="w-1 h-2 bg-[#FF2B2B] rounded-full"
                animate={{ y: [0, 10, 0] }}
      ...
      {/* ── OVERVIEW ── */}
      {project.overview && (
        <section className="w-full py-12 sm:py-14 lg:py-16 border-t border-neutral-800">
          <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
            <div className="relative rounded-3xl p-8 md:p-12 lg:p-16 overflow-hidden border border-neutral-800 bg-[#111111] shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 relative z-10">
                <motion.div
                  ...
                  transition={{ duration: 0.7 }}
                >
                  <span className="text-[#FF2B2B] text-base md:text-lg font-bold tracking-[0.2em] uppercase mb-4 block">Overview</span>
                  <h2 className="text-3xl md:text-4xl font-black text-white leading-tight mb-6">
                    {project.overview.headline}
                  </h2>
                  <p className="text-white/60 text-base leading-relaxed">{project.overview.paragraph}</p>
                </motion.div>
                      ...
                      <ul className="space-y-3">
                        {project.overview.challenges.map((c, i) => (
                          <li key={i} className="flex items-start gap-3">
                            <span className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[9px] font-black mt-0.5 bg-[#FF2B2B]/10 border border-[#FF2B2B]/20 text-[#FF2B2B]">
                              {i + 1}
                            </span>
                            <span className="text-white/60 text-sm leading-relaxed">{c}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
      ...
      {project.features?.length > 0 && (
        <section className="w-full py-12 sm:py-14 lg:py-16 bg-[#0A0A0A] border-t border-neutral-800">
          <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
            <motion.div
            ...
            >
              <span className="text-[#FF2B2B] text-base md:text-lg font-bold tracking-[0.2em] uppercase mb-3 block">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {project.features.map((f, i) => (
                <motion.div
                  key={f.id || i}
                  className="group relative rounded-2xl p-6 overflow-hidden transition-all duration-300 bg-[#111111] border border-neutral-800 shadow-sm"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: i * 0.07 }}
                  whileHover={{ y: -4, borderColor: "#FF2B2B" }}
                >
        ...
        <section className="w-full py-12 sm:py-14 lg:py-16 border-t border-neutral-800">
          <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <span className="text-[#FF2B2B] text-base md:text-lg font-bold tracking-[0.2em] uppercase mb-3 block">Impact</span>
                ...
                {project.results.map((r, i) => {
                  return (
                    <motion.div
                      ...
                      className="relative w-full h-full min-h-[180px] lg:min-h-[220px] flex flex-col justify-center items-center text-center rounded-[1.2rem] p-5 lg:p-7 bg-[#111111] border border-neutral-800 shadow-[0_8px_30px_rgba(0,0,0,0.06)]"
                    >
                      <h4 className="text-xl lg:text-2xl font-black text-white leading-tight mb-2">
                        {r.metric}
                      </h4>
      ...
      <section className="relative w-full py-12 sm:py-14 lg:py-16 overflow-hidden flex flex-col items-center justify-center bg-[#080808] border-t border-neutral-800">
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
          ...
          {project.techStack?.length > 0 && (
            <div className="mb-14">
              <motion.div
                ...
                className="mb-10"
              >
                <span className="text-[#FF2B2B] text-[11px] font-black tracking-[0.4em] uppercase mb-4 block">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {project.techStack.map((tech, i) => (
                  <motion.span
                    key={i}
                    className="relative px-6 py-3 rounded-xl text-[11px] font-black uppercase tracking-wider bg-white/5 border border-neutral-800 text-white/80"
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: i * 0.04 }}
                    whileHover={{ scale: 1.05, color: "#fff", borderColor: "#FF2B2B" }}
                  >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/projects"
                className="inline-flex items-center justify-center gap-3 px-10 py-4 rounded-full bg-[#FF2B2B] text-white text-sm font-black hover:bg-[#E51D1D] shadow-[0_10px_24px_rgba(255,43,43,0.22)] transition-all duration-300"
              >
                View All Projects
