...
export default function ProjectBriefModal({ isOpen, onClose, initialQuotationData = null }) {
  ...
  return ReactDOM.createPortal(
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2.5 sm:p-6 lg:p-8 overflow-hidden font-sans">
          {/* Backdrop Overlay */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            className="w-full sm:w-[96%] lg:w-full max-w-[1350px] h-[95dvh] sm:h-[92dvh] sm:max-h-[92dvh] bg-[#FAFAFA] rounded-2xl sm:rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.2)] border border-neutral-300 sm:border-[#111111] relative flex flex-col overflow-hidden text-[#111111] z-10 my-auto"
          ...
          >
            ...
            <div className="bg-white border-b border-neutral-100 z-20 relative flex flex-col">
              ...
              <div className="px-3.5 py-2.5 sm:px-10 sm:py-5 flex items-center justify-between gap-2.5">
                <div className="flex items-center gap-2.5 sm:gap-4 truncate">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-[#111111] text-white flex items-center justify-center shrink-0 shadow-xs">
                    {React.createElement(currentStepInfo.icon, { className: "w-4 h-4 sm:w-5 sm:h-5 text-white" })}
                  </div>
                  <div className="truncate">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <span className="text-[9.5px] sm:text-[11px] font-black text-[#111111] tracking-[0.15em] sm:tracking-[0.25em] uppercase">
                    ...
                    <h2 className="text-sm sm:text-2xl font-black text-[#111111] tracking-tight mt-0.5 truncate max-w-[200px] xs:max-w-[260px] sm:max-w-none">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="w-8 h-8 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-neutral-100 hover:bg-neutral-200 text-neutral-600 hover:text-neutral-900 flex items-center justify-center transition-all focus:outline-none shrink-0"
            ...
            {submitSuccess ? (
              ...
              <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
                ...
                {/* Mobile Stepper Bar */}
                <div className="w-full bg-[#FAFAFA] border-b border-neutral-200/60 p-2 flex md:hidden overflow-x-auto gap-1.5 shrink-0 scrollbar-none">
                  {steps.map((step) => {
                    const isActive = activeSection === step.num;
                    return (
                      <button
                ...
                <div className="flex-1 flex flex-col justify-between overflow-y-auto relative">
                  <form onSubmit={handleSubmit} className="p-3.5 sm:p-10 lg:p-14 space-y-4 sm:space-y-8 flex-1">
                    {submitError && (
                      ...
                      >
                        ...
                        {activeSection === 1 && (
                          <div className="space-y-3.5 sm:space-y-6">
                            <div className="border-b border-neutral-100 pb-3 sm:pb-5">
                              <span className="text-[10px] sm:text-[11px] font-black text-[#111111] tracking-[0.2em] sm:tracking-[0.25em] uppercase">
                                SECTION 1 OF 10
                              </span>
                              <h3 className="text-lg sm:text-3xl font-black text-[#111111] tracking-tight mt-0.5 sm:mt-1">
                                Company Information
                              </h3>
                              <p className="text-xs sm:text-sm text-neutral-500 font-normal mt-1 sm:mt-1.5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
                              <div>
                                <label className="block text-[11px] sm:text-xs font-bold text-neutral-800 mb-1 sm:mb-2">
                                ...
                                <input
                                  ...
                                  className={`w-full h-[46px] sm:h-[56px] px-3.5 sm:px-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border rounded-xl sm:rounded-[16px] placeholder:text-neutral-400 transition-all outline-none ${
                                    errors.companyName
                                ...
                                />
                                {errors.companyName && (
                                  <p className="text-red-500 text-[10px] sm:text-[11px] font-medium mt-1">
                                    {errors.companyName}
                                  </p>
                                )}
                              </div>
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <select
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full h-[46px] sm:h-[56px] pl-3.5 pr-10 sm:pl-5 sm:pr-12 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border border-neutral-200/80 focus:bg-white focus:border-[#E31D2E] focus:ring-4 focus:ring-[#E31D2E]/15 rounded-xl sm:rounded-[16px] transition-all outline-none cursor-pointer appearance-none"
                                  >
                                  ...
                                  <ChevronDown className="w-4 h-4 text-neutral-500 absolute right-3.5 sm:right-4 top-1/2 -translate-y-1/2 pointer-events-none" />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full h-[46px] sm:h-[56px] px-3.5 sm:px-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border border-neutral-200/80 focus:bg-white focus:border-[#E31D2E] focus:ring-4 focus:ring-[#E31D2E]/15 rounded-xl sm:rounded-[16px] transition-all outline-none"
                                />
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full p-3.5 sm:p-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border border-neutral-200/80 focus:bg-white focus:border-[#111111] focus:ring-4 focus:ring-neutral-200 rounded-xl sm:rounded-[20px] transition-all outline-none resize-y min-h-[90px] sm:min-h-[120px]"
                              />
                            </div>
                          </div>
                        )}
                        ...
                        {activeSection === 2 && (
                          <div className="space-y-3.5 sm:space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full h-[46px] sm:h-[56px] px-3.5 sm:px-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border rounded-xl sm:rounded-[16px] transition-all outline-none ${
                                    errors.fullName
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full h-[46px] sm:h-[56px] px-3.5 sm:px-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border border-neutral-200/80 focus:bg-white focus:border-[#111111] focus:ring-4 focus:ring-neutral-200 rounded-xl sm:rounded-[16px] transition-all outline-none"
                                />
                              </div>
                            </div>
                            ...
                            <div>
                              <label className="block text-[11px] sm:text-xs font-bold text-neutral-800 mb-2 sm:mb-3">
                              ...
                              <div className="flex flex-wrap gap-2.5 sm:gap-4">
                                {["Email", "Phone", "WhatsApp"].map((method) => (
                                  <label
                                    key={method}
                                    className={`flex items-center gap-2.5 cursor-pointer text-xs font-bold px-3.5 py-2.5 sm:p-4 border rounded-xl sm:rounded-[16px] transition-all ${
                        ...
                        {activeSection === 3 && (
                          <div className="space-y-3.5 sm:space-y-6">
                            ...
                            <div>
                              ...
                              <div className="flex gap-2.5 sm:gap-4">
                                {["Yes", "No"].map((opt) => (
                                  <label
                                    key={opt}
                                    className={`flex items-center gap-2.5 cursor-pointer text-xs font-bold px-4 py-2.5 sm:px-6 sm:py-4 rounded-xl sm:rounded-[16px] border transition-all ${
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                                {["Brand Guidelines", "Color Palette", "Typography", "Brand Book"].map(
                                  (asset) => (
                                    <label
                                      key={asset}
                                      className={`flex items-center gap-2 cursor-pointer text-[11px] sm:text-xs font-bold p-2.5 sm:p-4 border rounded-xl sm:rounded-[16px] transition-all ${
                            ...
                            <div>
                              ...
                              />
                              <div className="mt-2">
                                <label className="block text-[10px] sm:text-[11px] font-semibold text-neutral-500 mb-1">
                                ...
                                <input
                                  ...
                                  className="block w-full text-[11px] sm:text-xs text-neutral-600 file:mr-3 file:py-1.5 file:px-3 sm:file:py-2.5 sm:file:px-4 file:rounded-lg sm:file:rounded-xl file:border-0 file:text-[11px] sm:file:text-xs file:font-semibold file:bg-[#E31D2E]/10 file:text-[#E31D2E] hover:file:bg-[#E31D2E]/20"
                                />
                                {files.logoFile && (
                                  <p className="text-[11px] text-emerald-600 font-semibold mt-1">✓ Attached: {files.logoFile.name}</p>
                                )}
                              </div>
                            </div>
                          ...
                          <div className="space-y-3.5 sm:space-y-6">
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full p-3.5 sm:p-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border border-neutral-200/80 focus:bg-white focus:border-[#111111] focus:ring-4 focus:ring-neutral-200 rounded-xl sm:rounded-[20px] transition-all outline-none resize-y min-h-[90px] sm:min-h-[140px]"
                              />
                            </div>
                          </div>
                        )}
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                                {["Immediately", "Within 2 Weeks", "Within 1 Month", "Flexible"].map(
                                  (time) => (
                                    <label
                                      key={time}
                                      className={`flex items-center gap-2 cursor-pointer text-xs font-bold p-3 sm:p-5 border rounded-xl transition-all ${
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4">
                                {[
                                  ...
                                  <label
                                    key={b}
                                    className={`flex items-center gap-2.5 cursor-pointer text-xs sm:text-sm font-bold p-3 sm:p-5 border rounded-xl transition-all ${
                            ...
                            <div>
                              ...
                              <div className="mt-2">
                                ...
                                <input
                                  ...
                                  className="block w-full text-[11px] sm:text-xs text-neutral-600 file:mr-3 file:py-1.5 file:px-3 sm:file:py-2.5 sm:file:px-4 file:rounded-lg sm:file:rounded-xl file:border-0 file:text-[11px] sm:file:text-xs file:font-semibold file:bg-neutral-200/50 file:text-[#111111] hover:file:bg-neutral-200"
                                />
                                {files.referenceFile && (
                                  <p className="text-[11px] text-emerald-600 font-semibold mt-1">✓ Attached: {files.referenceFile.name}</p>
                                )}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-3.5 sm:space-y-6">
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full p-3.5 sm:p-5 text-xs sm:text-sm font-medium text-[#111111] bg-neutral-50/60 border border-neutral-200/80 focus:bg-white focus:border-[#111111] focus:ring-4 focus:ring-neutral-200 rounded-xl sm:rounded-[20px] transition-all outline-none resize-y min-h-[100px] sm:min-h-[160px]"
                              />
                            </div>
                          </div>
                        )}
                        ...
                        {activeSection === 10 && (
                          <div className="space-y-3.5 sm:space-y-6">
                            <div className="border-b border-neutral-100 pb-3 sm:pb-5 flex items-center justify-between">
                              <div>
                                <span className="text-[10px] sm:text-[11px] font-black text-[#111111] tracking-[0.2em] sm:tracking-[0.25em] uppercase">
                                  SECTION 10 OF 10
                                </span>
                            ...
                            <div className="border border-neutral-200/90 rounded-2xl sm:rounded-[24px] bg-neutral-50/80 overflow-hidden shadow-inner">
                              <div className="px-4 py-3 sm:px-6 sm:py-4 border-b border-neutral-200/80 bg-neutral-100/70 flex items-center justify-between flex-wrap gap-2">
                                <div>
                                  <h4 className="text-xs sm:text-sm font-extrabold text-[#111111]">Comprehensive Application Summary</h4>
                                  <p className="text-[10px] sm:text-[11px] text-neutral-500 font-medium">Verify your answers across all 10 project onboarding sections below</p>
                                </div>
                                <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-lg sm:rounded-xl bg-neutral-100 text-[#111111] border border-black">
                                  10 / 10 Sections
                                </span>
                              </div>

                              <div className="p-3.5 sm:p-6 max-h-[300px] sm:max-h-[380px] overflow-y-auto space-y-4 sm:space-y-6 custom-scrollbar text-xs">
                                {/* 1. Company Profile */}
                                <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                  <div className="flex items-center justify-between">
                                    <span className="font-extrabold text-[#111111] text-[11px] sm:text-xs uppercase tracking-wide flex items-center gap-1.5">
                                      <Building2 className="w-3.5 h-3.5 text-[#111111]" /> 1. Company Profile
                                    </span>
                                    <button type="button" onClick={() => setActiveSection(1)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                      Edit Section 1
                                    </button>
                                  </div>
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-neutral-600">
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Company Name</span>
                                      <span className="font-bold text-[#111111]">{formData.companyName || "Not specified"}</span>
                                    </div>
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Business Type & Industry</span>
                                      <span className="font-bold text-[#111111]">{formData.industry || "Not specified"} ({formData.businessType})</span>
                                    </div>
                                    {formData.companyWebsite && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Website</span>
                                        <span className="font-semibold text-neutral-800">{formData.companyWebsite}</span>
                                      </div>
                                    )}
                                    {formData.yearsInBusiness && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Years in Business</span>
                                ...
                                <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" onClick={() => setActiveSection(2)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                      Edit Section 2
                                    </button>
                                  </div>
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-neutral-600">
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Full Name & Role</span>
                                      <span className="font-bold text-[#111111]">{formData.fullName || "Not specified"} {formData.designation && `(${formData.designation})`}</span>
                                    </div>
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Email & Phone</span>
                                      <span className="font-bold text-[#111111]">{formData.email} | {formData.phone}</span>
                                    </div>
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Preferred Contact</span>
                                      <span className="font-semibold text-neutral-800">{formData.preferredContactMethod}</span>
                                    </div>
                                    {(formData.city || formData.country) && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Location</span>
                                ...
                                <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" onClick={() => setActiveSection(3)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                      Edit Section 3
                                    </button>
                                  </div>
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-neutral-600">
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Has Logo?</span>
                                    ...
                                    {formData.existingAssets?.length > 0 && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Existing Assets</span>
                                        <span className="font-semibold text-[#111111]">{formData.existingAssets.join(", ")}</span>
                                      </div>
                                    )}
                                    {formData.preferredColors && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Brand Colors</span>
                                        <span className="font-semibold text-neutral-800">{formData.preferredColors}</span>
                                      </div>
                                    )}
                                    {formData.brandStyles?.length > 0 && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Brand Styles</span>
                                ...
                                <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" onClick={() => setActiveSection(4)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                      Edit Section 4
                                    </button>
                                  </div>
                                  <div>
                                    {formData.services?.length > 0 ? (
                                      <div className="flex flex-wrap gap-1 mt-1">
                                        {formData.services.map((srv) => (
                                          <span key={srv} className="px-2.5 py-0.5 rounded-lg bg-neutral-100 text-[#111111] border border-neutral-200 text-[10px] sm:text-[11px] font-bold">
                                            {srv}
                                          </span>
                                        ))}
                                      </div>
                                ...
                                <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" onClick={() => setActiveSection(5)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                      Edit Section 5
                                    </button>
                                  </div>
                                  <div>
                                    {formData.projectGoals?.length > 0 ? (
                                      <div className="flex flex-wrap gap-1 mt-1">
                                        {formData.projectGoals.map((g) => (
                                          <span key={g} className="px-2.5 py-0.5 rounded-lg bg-neutral-200/80 text-neutral-800 text-[10px] sm:text-[11px] font-extrabold">
                                            {g}
                                          </span>
                                        ))}
                                      </div>
                                    ...
                                    {formData.projectDetail && (
                                      <p className="text-neutral-700 text-xs mt-2 p-2.5 rounded-lg sm:rounded-xl bg-white border border-neutral-200/70 leading-relaxed">
                                        "{formData.projectDetail}"
                                      </p>
                                    )}
                                  </div>
                                ...
                                <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" onClick={() => setActiveSection(6)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                      Edit Section 6/7
                                    </button>
                                  </div>
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-neutral-600">
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Budget Range</span>
                                      <span className="font-extrabold text-[#111111] text-xs sm:text-sm">{formData.budgetRange}</span>
                                    </div>
                                    <div>
                                      <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Start Schedule</span>
                                      <span className="font-bold text-[#111111]">{formData.startDate}</span>
                                    </div>
                                    {formData.expectedCompletionDate && (
                                      <div>
                                        <span className="text-neutral-400 block text-[9.5px] sm:text-[10px] font-bold uppercase">Target Completion</span>
                                ...
                                {(formData.referenceWebsites || formData.competitorWebsites || formData.driveLinks) && (
                                  <div className="space-y-1.5 sm:space-y-2 pb-3 sm:pb-4 border-b border-neutral-200/60">
                                    <div className="flex items-center justify-between">
                                      ...
                                      <button type="button" onClick={() => setActiveSection(8)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                        Edit Section 8
                                      </button>
                                    </div>
                                    <div className="space-y-1 text-neutral-600 text-[11px] sm:text-xs">
                                ...
                                {formData.additionalInfo && (
                                  <div className="space-y-1.5 sm:space-y-2">
                                    <div className="flex items-center justify-between">
                                      ...
                                      <button type="button" onClick={() => setActiveSection(9)} className="text-[10px] sm:text-[11px] font-bold text-[#111111] hover:underline cursor-pointer">
                                        Edit Section 9
                                      </button>
                                    </div>
                                    <p className="text-neutral-700 text-[11px] sm:text-xs p-2.5 rounded-lg sm:rounded-xl bg-white border border-neutral-200/70 leading-relaxed">
                                      {formData.additionalInfo}
                                    </p>
                                  </div>
                                )}
                            ...
                            <div>
                              <label className="flex items-start gap-3 cursor-pointer p-3.5 sm:p-6 border border-neutral-200/80 rounded-xl sm:rounded-[20px] bg-white hover:bg-neutral-50 transition-all">
                                <input
                                  type="checkbox"
                                  name="agreed"
                                  checked={formData.agreed}
                                  onChange={handleInputChange}
                                  className="mt-0.5 accent-[#E31D2E] w-4 h-4 sm:w-5 sm:h-5"
                                />
                  ...
                  <div className="sticky bottom-0 bg-white/95 backdrop-blur-md border-t border-neutral-100 py-2.5 px-3.5 sm:py-4 sm:px-10 lg:px-14 z-30 flex items-center justify-between shadow-xs">
                    {activeSection > 1 ? (
                      <button
                        type="button"
                        onClick={handlePrev}
                        className="h-[44px] sm:h-[56px] px-4 sm:px-8 rounded-xl border border-neutral-200 text-neutral-700 hover:bg-neutral-100 font-bold text-xs sm:text-sm transition-all flex items-center gap-1.5 sm:gap-2 cursor-pointer"
                      >
                    ...
                    <button
                      ...
                      className="h-[44px] sm:h-[56px] px-5 sm:px-10 rounded-xl bg-[#E31D2E] hover:bg-[#c91827] text-white font-bold text-xs sm:text-base shadow-[0_8px_20px_rgba(0,0,0,0.12)] hover:shadow-[0_12px_28px_rgba(0,0,0,0.16)] hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center gap-2 sm:gap-2.5 cursor-pointer disabled:opacity-60"
                    >
                      {isSubmitting ? (
                        <>
